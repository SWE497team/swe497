...
@NamedQueries({
    ...
    , @NamedQuery(name = "Matrial.findByMatrialcol", query = "SELECT m FROM Matrial m WHERE m.matrialcol = :matrialcol")
...
public class Matrial implements Serializable {
    ...
    private String file;
    @Size(max = 45)
    @Column(name = "matrialcol")
    private String matrialcol;
    @Id
    ...
    public String getMatrialcol() {
        return matrialcol;
    }

    public void setMatrialcol(String matrialcol) {
        this.matrialcol = matrialcol;
    }
    ...
    public String toString() {
        return "entity.Matrial[ postId=" + postId + " ]";
    }
